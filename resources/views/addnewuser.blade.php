                ...
                <div class="card-body">
                    <form method="POST" action="submited">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fname" type="text" class="form-control @error('name') is-invalid @enderror" name="fname" value="{{ old('name') }}" required autocomplete="fname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pincode" type="text" class="form-control " name="pincode" value="{{ old('pincode') }}" required autocomplete="pincode">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control " name="country" value="{{ old('state') }}" required autocomplete="country">
